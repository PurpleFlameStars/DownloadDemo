...
public class DownloadService extends Service {
    ...
    private String DOWNLOAD_DIR=Environment.getExternalStorageDirectory()+File.separator+"image";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //Log.i("abc", "onStartCommand: "+mDownloadUrl);
    ...
    private void notifyMsg(String title, String content, int progress) {
        ...
        builder.setSmallIcon(R.drawable.bg_avatar).setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.bg_avatar)).setContentTitle(title);
    ...
    private PendingIntent getInstallIntent() {
        File file = new File(DOWNLOAD_DIR + "APP文件名");
    ...
    private void downloadFile(String url) {
        ...
        OkHttpUtils.get().url(url).build().execute(new FileCallBack(DOWNLOAD_DIR, "APP文件名") {
            @Override
            ...
            public void inProgress(float v, long l) {
                if ((int) (v * 100) % 10 == 0) {
                    ...
                    notifyMsg("温馨提醒", "文件正在下载..", (int) (v * 100));
                }
            }
           /* @Override
